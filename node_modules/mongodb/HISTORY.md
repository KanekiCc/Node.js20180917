...
* NODE-606 better error handling on destroyed topology for dbff.js methods.
...
* Added db(dbName) method to dbff.js to allow for reuse of connections against other databases
